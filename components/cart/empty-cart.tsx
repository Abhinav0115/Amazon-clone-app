                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="flex gap-5">
                                    <Link href="/auth/signin">
                                        <button className="bg-yellow-300 hover:bg-yellow-400 text-xs sm:text-sm shadow border font-semibold rounded-md px-3 py-2 hover:underline ">
                                            Sign in to your account
                                        </button>
                                    </Link>
                                    <Link href="/auth/signin">
                                        <button className="bg-white text-xs sm:text-sm hover:bg-gray-50 border-e-1 shadow border rounded-md px-3 py-2 hover:underline ">
                                            Sign up now
                                        </button>
                                    </Link>
                                </div>
            ...
            <div className="w-full mt-5 mb-12">
                ...
                <div className="flex flex-col justify-center items-center m-9">
                    <div className="lg:w-1/4 md:w-2/4 w-full text-center space-y-1">
                        ...
                        <Link href={"/auth/signin"}>
                            <button className="bg-[#ffcd4e] text-base md:w-4/5 w-full rounded p-1.5 font-bold shadow leading-tight hover:underline">
                                Sign in
                            </button>
                        </Link>
